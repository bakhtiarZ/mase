module linear_layer_carousel_corrected #(
    ...
    // Weight unpacking signals - now using multiple carousel slots
    ...
    // ============================================================================
    // Weight Carousel Implementation - CORRECTED VERSION
    // ============================================================================
    ...
    // ============================================================================
    // Weight Unpacking from Carousel - USING MULTIPLE SLOTS
    // ============================================================================
    // Now we can use different carousel slots for different purposes
    // Slot 0: Current weights being computed
    // Slot 1: Next weights being loaded
    // Slot 2: Previous weights for pipelining
    
    always_comb begin
        // Use slot 0 for current computation
